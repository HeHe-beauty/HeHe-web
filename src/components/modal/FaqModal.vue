...
const faqs = [
  ...
  {
    q: '레이저 제모란 무엇인가요?',
    a: '레이저 빛으로 모낭을 파괴해 체모를 영구적으로 감소시키는 시술입니다. 면도나 왁싱과 달리 반복 시술 후 체모가 점차 줄어들어 장기적으로 효율적입니다.',
  },
  {
    q: '어떤 레이저 장비가 좋은가요?',
    a: '레이저 제모는 장비의 강도, 비용 등 선호도에 따라 선택하면 됩니다. 털이 두꺼운 타입일 경우 레이저 파장이 강한 장비를 골라야 해요. HEHE 앱에서 더 자세히 찾아보세요.',
  },
  {
    q: '병원은 어떻게 고르는 게 좋을까요?',
    a: '장비 종류, 시술 경력, 위생 환경 등을 고려하세요. HEHE 앱에서는 장비 필터로 원하는 장비를 쉽게 찾을 수 있습니다.',
  },
]
</script>
